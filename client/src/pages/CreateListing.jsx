...
//               className="p-3 rounded border border-green-700 text-green-700 hover:shadow-lg disabled:opacity-80"
//             >
...
//                 <div key={url} className="flex justify-between border p-3 items-center rounded">
//                 <img src={url} alt="listing image" className="w-20 h-20 object-contain rounded-lg" />
//                 <button type="button" onClick={()=>handleRemoveImage(index)} className="p-3 text-red-700 rounded-lg uppercase hover:opacity-85">Delete</button>
//                 </div>
//             ))
//           }
